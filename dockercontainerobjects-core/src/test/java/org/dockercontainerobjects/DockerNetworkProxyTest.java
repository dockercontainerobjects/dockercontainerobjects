...
public class DockerNetworkProxyTest {
    ...
    void noProxy() throws IOException {
        ...
        try (ContainerObjectsEnvironment env = ContainerObjectsEnvironmentFactory.newEnvironment()) {
    ...
    void socksProxy() throws IOException {
        ...
        try (ContainerObjectsEnvironment env = ContainerObjectsEnvironmentFactory.newEnvironment(properties)) {
